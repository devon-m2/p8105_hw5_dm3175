...
``` r
prop.test(x = 750, n = 2205, p = 0.30, alternative = "greater", conf.level = 0.95, correct = FALSE)
```

    ## 
    ##  1-sample proportions test without continuity correction
    ## 
    ## data:  750 out of 2205, null probability 0.3
    ## X-squared = 16.914, df = 1, p-value = 1.955e-05
